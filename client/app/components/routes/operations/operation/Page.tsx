...
import OperationReviewForm from "@/app/components/operations/OperationReviewForm";
...
export default async function OperationsOperationPage({
  ...
  if (params.operation && isValidUUID(params.operation)) {
    operation = await getOperation(params.operation);
  }
