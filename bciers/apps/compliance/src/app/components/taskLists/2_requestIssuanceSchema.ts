  ...
  const taskItems = [
    {
      ...
      link: `/compliance-summaries/${complianceSummaryId}/request-issuance/review-compliance-summary`,
      isActive: activeIndex === ActivePage.ReviewComplianceSummary,
    },
    {
      type: "Page" as const,
      title: "Request Issuance of Earned Credits",
      link: `/compliance-summaries/${complianceSummaryId}/request-issuance/request-issuance-of-earned-credits`,
      isActive: activeIndex === ActivePage.RequestIssuanceOfEarnedCredits,
    },
    {
      type: "Page" as const,
      title: "Track Status of Issuance",
      link: `/compliance-summaries/${complianceSummaryId}/request-issuance/track-status-of-issuance`,
