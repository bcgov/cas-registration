...
export const createComplianceSummaryReviewSchema = (reportingYear: number): RJSFSchema => ({
  ...
  properties: {
    ...
    // Obligation Section
    obligationHeader: readOnlyObjectField(`${reportingYear} Compliance Obligation`),
    obligationId: readOnlyStringField("Obligation ID:"),
    complianceChargeRate: readOnlyStringField(`${reportingYear} Compliance Charge Rate:`),
    ...
    outstandingObligationHeader: readOnlyObjectField("Outstanding Compliance Obligation"),
    ...
    // Penalty Section
    penaltyHeader: readOnlyObjectField("Automatic Overdue Penalty (as of Today):"),
