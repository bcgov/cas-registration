  ...
  rows: [
    {
      ...
      display_status: "Obligation - not met",
    ...
    },
    {
      ...
      display_status: "No obligation or earned credits",
      penalty_status: null,
      obligation_id: null,
    },
    {
      ...
      display_status: "Earned credits - issuance requested",
      penalty_status: null,
      obligation_id: null,
    ...
    },
    {
      ...
      status: "Earned credits",
      display_status: "Earned credits - not requested",
      penalty_status: "N/A",
    ...
    },
    {
      ...
      outstanding_balance: 1,
      status: "Earned credits",
      display_status: "Earned credits - approved",
      penalty_status: "N/A",
      obligation_id: undefined,
    ...
    },
    {
      ...
      display_status: "Obligation - pending invoice creation",
      penalty_status: "N/A",
...
describe("ComplianceSummariesDataGrid component", () => {
  it("renders the ComplianceSummariesDataGrid with initial data", async () => {
    ...
    expect(
      ...
      "href",
      "/compliance/compliance-administration/compliance-summaries/1/review-compliance-obligation-report",
    );
    ...
    expect(
      ...
      "href",
      "/compliance/compliance-administration/compliance-summaries/2/review-compliance-no-obligation-report",
    );
    ...
    expect(
      ...
      "href",
      "/compliance/compliance-administration/compliance-summaries/3/review-compliance-earned-credits-report",
    );
    ...
    expect(
      ...
      "href",
      "/compliance/compliance-administration/compliance-summaries/4/review-compliance-earned-credits-report",
    );
    ...
    expect(
      ...
      "href",
      "/compliance/compliance-administration/compliance-summaries/5/review-compliance-earned-credits-report",
    );
    ...
    expect(
      ...
      "href",
      "/compliance/compliance-administration/compliance-summaries/9/review-compliance-obligation-report",
    );
  });
  ...
  it("shows 'View Details' for internal users when there's a final decision (APPROVED/DECLINED)", async () => {
    ...
    expect(
      ...
      "href",
      "/compliance/compliance-administration/compliance-summaries/6/track-status-of-issuance",
    );
  });
  ...
  it("shows 'Resolve Issue' link to resolve-issue for CAS users when director_decision is pending_manual_handling", () => {
    ...
    expect(link).toHaveAttribute(
      "href",
      "/compliance/compliance-administration/compliance-summaries/102/resolve-issue",
    );
  });
  ...
  it("shows 'View Details' link to resolve-issue for CAS users when director_decision is issue_resolved", () => {
    ...
    expect(link).toHaveAttribute(
      "href",
      "/compliance/compliance-administration/compliance-summaries/101/resolve-issue",
    );
  });
});
