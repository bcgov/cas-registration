...
const ReviewFacilities = ({ version_id }: Props) => {
  ...
  const continueUrl = '/reports/${version_id}/report-information';
  ...
  const taskListElements: TaskListElement[] = [
    {
      ...
      elements: [
        ...
        },
        {
          ...
          link: `/reports/${version_id}/review-facilities`,
        },
      ],
    },
  ];
    ...
    <>
      <MultiStepFormWithTaskList
        ...
        uiSchema={{
          ...reviewFacilitiesUiSchema,
          sync_button: {
            ...reviewFacilitiesUiSchema.sync_button,
            "ui:options": {
              onSync: handleSync,
            },
          },
