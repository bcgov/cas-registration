...
export default async function Page() {
  ...
  const activityData = await actionHandler(
    `reporting/initial-activity-data?activity_name=General stationary combustion, other than non-compression and non-processing combustion&report_date=${reportDate}`,
    "GET",
    "",
  );
