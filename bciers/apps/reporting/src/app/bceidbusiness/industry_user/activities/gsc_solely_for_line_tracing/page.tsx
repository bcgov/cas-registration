import GeneralStationaryCombustion from "../../../../components/activities/generalStationaryCombustionLineTracing";
...
export default async function Page() {
  ...
  const activityData = await actionHandler(
    `reporting/initial-activity-data?activity_name=General stationary combustion solely for the purpose of line tracing&report_date=${reportDate}`,
    "GET",
    "",
  );
