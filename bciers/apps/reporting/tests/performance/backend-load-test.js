...
const stages = [
  ...
  // { duration: "45s", target: 5 }, // Increase to 5 VUs
  // { duration: "1m", target: 10 }, // Peak load at 10 VUs
  // { duration: "30s", target: 5 }, // Reduce to 5 VUs
  // { duration: "15s", target: 2 }, // Cool down to 2 VUs
