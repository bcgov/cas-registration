...
import FacilityReview from "@reporting/src/app/components/facilities/FacilityReview";
import { vi } from "vitest"; // If you are using Vitest for mocking
...
describe("FacilityReview", () => {
  ...
  it("should handle loading state correctly", async () => {
    (actionHandler as vi.Mock).mockImplementationOnce(
  ...
  it("should handle form submission successfully", async () => {
    ...
    await waitFor(() => {
      expect(actionHandler).toHaveBeenCalledWith(
        `reporting/report-version/1/report-facility/1`,
        "POST",
        `reporting/report-version/1/report-facility/1`,
