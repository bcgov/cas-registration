...
const getDashboardTiles = async () => {
  const dashboardTiles = await actionHandler(
    "registration/v2/dashboard-tiles",
    "GET",
    "",
  );
...
export default async function Page() {
  ...
  const dashboardTiles = (await getDashboardTiles()) as TileContent[];
