...
ENDPOINTS = {
    ...
    "approved_industry_user": [
        ...
        {
            "method": "get",
            "endpoint_name": "get_emission_allocation_form_data",
            "kwargs": {"version_id": MOCK_INT, "facility_id": MOCK_UUID},
        },
        {
            "method": "get",
        ...
        {
            "method": "get",
            "endpoint_name": "get_report_validation_data",
            "kwargs": {"version_id": MOCK_INT},
        },
        {
            "method": "get",
        ...
        {
            "method": "get",
            "endpoint_name": "get_accruing_penalties",
            "kwargs": {
                "compliance_report_version_id": MOCK_INT,
            },
        },
    ...
    "all_roles": [
        ...
        {"method": "get", "endpoint_name": "get_current_compliance_penalty_rate"},
