...
# TODO: move this into test_operator_endpoints or test_operator_service
# def test_send_operator_access_request_email(email_service: EmailService, mocker):
...
#             template_instance = EmailNotificationTemplate.objects.get(name=template_name)
