...
from . import core, features, installation, migrations
    ...
    if features.migrations():  # pragma: no branch
        ...
        if not issubclass(  # pragma: no branch
            ...
            makemigrations.MigrationAutodetector = type(
                ...
                (
                    migrations.MigrationAutodetectorMixin,
                    makemigrations.MigrationAutodetector,
                ),
                {},
            )

        if not issubclass(migrate.MigrationAutodetector, migrations.MigrationAutodetectorMixin):  # pragma: no branch
