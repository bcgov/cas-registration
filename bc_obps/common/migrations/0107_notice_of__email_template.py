...
def create_penalty_after_compliance_met_notice_email_template(apps, schema_editor):
    EmailNotificationTemplate = apps.get_model("common", "EmailNotificationTemplate")
    EmailNotificationTemplate.objects.create(
        name="Notice of Penalty After Compliance Met",
        ...
        body="""
            ...
            <p>
              As the compliance obligation for compliance period {{ compliance_year }} was not met by the November 30th deadline,
            ...
            <p>
              <em>Please do not reply to this email. This email is auto-generated and sent from an unmonitored address. If you have
...
def reverse_penalty_after_compliance_met_notice_email_template(apps, schema_editor):
    EmailNotificationTemplate = apps.get_model("common", "EmailNotificationTemplate")
    EmailNotificationTemplate.objects.filter(name="Notice of Penalty After Compliance Met").delete()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            create_penalty_after_compliance_met_notice_email_template,
            reverse_penalty_after_compliance_met_notice_email_template,
            elidable=True,
        )
    ]
