...
def create_obligation_due_template(apps, schema_editor):
    ...
    EmailNotificationTemplate.objects.create(
        ...
        body='''
            ...
            <br>
            <p>Based on the information submitted in <b>{{operation_name}}</b>’s Annual Report for the {{compliance_period}} compliance period and the applicable compliance charge rate, a compliance obligation for excess emissions of {{tonnes_of_cod2}} at an equivalent amount of  {{dollar_amount}} is now payable.   </p>
            <p>You have the option to use compliance units to meet part of your obligation. When you apply compliance units against your obligation, BCIERS automatically adjusts the equivalent monetary amount due on the invoice. To review your compliance obligation and how it was calculated, please log-into BCIERS at <a href=https://industrialemissions.gov.bc.ca/onboarding>https://industrialemissions.gov.bc.ca/onboarding</a>.  </p><br>
            ...
            <p>You must meet your compliance obligation by <b>November 30, {{compliance_period + 1}}</b>.</p>
            <br>
            <p>
