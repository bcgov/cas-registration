...
class Rls:
    role_grants_mapping = {
        ...
        RlsRoles.CAS_DIRECTOR: [RlsOperations.SELECT, RlsOperations.UPDATE, RlsOperations.DELETE],
    ...
    grants = generate_rls_grants(role_grants_mapping, RegistryTableNames.SUB_ACCOUNT)
