# Generated by Django 5.1.15 on 2026-02-18 15:54
import os
import json
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activities', models.ManyToManyField(related_name='+', to='registration.activity')),
                (
                    'archived_by',
                    models.ForeignKey(
                        blank=True,
        ...
        django.contrib.postgres.operations.BtreeGistExtension(),  # Enable btree gist extension in Postgres to handle fkey constraint equal condition below
        migrations.CreateModel(
        ...
        migrations.AddConstraint(
            model_name='reportemission',
            constraint=models.CheckConstraint(
                condition=models.Q(('report_fuel__isnull', False), ('report_unit__isnull', False), _negated=True),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'constraints': [
                    models.CheckConstraint(
                        condition=models.Q(
                            ('is_other_visit', False), ('visit_coordinates__isnull', False), _connector='OR'
                        ),
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash='2aeb20c0eb58e199a2e503f23a6d84650dceeeab',
                    operation='UPDATE',
