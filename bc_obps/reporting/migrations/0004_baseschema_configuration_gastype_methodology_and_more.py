...
def init_base_schema_data(apps, schema_monitor):
    ...
    cwd = os.getcwd()
    with open(
        f'{cwd}/reporting/base_json_schemas/general_stationary_combustion/gsc_of_fuel_or_waste_with_production_of_useful_energy_2024.json'
    ) as gsc_st1:
    ...
    ASTBS.objects.bulk_create(
        [
            ASTBS(
                ...
                base_schema_id=BaseSchema.objects.get(
                    slug='gsc_of_fuel_or_waste_with_production_of_useful_energy_2024'
                ).id,
            ...
            ASTBS(
                ...
                base_schema_id=BaseSchema.objects.get(
                    slug='gsc_of_fuel_or_waste_without_production_of_useful_energy_2024'
                ).id,
                valid_from_id=Configuration.objects.get(valid_from='2024-01-01').id,
                valid_to_id=Configuration.objects.get(valid_to='9999-12-31').id,
            ),
...
def reverse_init_activity_source_type_base_schema_data(apps, schema_monitor):
    ...
    '''
    ASTBS = apps.get_model('reporting', 'ActivitySourceTypeBaseSchema')
    ASTBS.objects.filter(valid_from='2024-01-01', valid_to='9999-12-31').delete()
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'field_units',
                    models.CharField(
                        null=True, db_comment='Units associated to the field_name. example: kg/GJ', max_length=100
                    ),
                ),
            ],
            options={
        ...
        migrations.RunPython(
            init_activity_source_type_base_schema_data, reverse_init_activity_source_type_base_schema_data
        ),
        migrations.CreateModel(
