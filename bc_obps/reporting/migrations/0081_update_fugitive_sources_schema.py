...
def update_other_fugitive_sources_schema(apps, schema_monitor):
    """
    ...
    cwd = os.getcwd()
    with open(
        f"{cwd}/reporting/json_schemas/2024/og_extraction_other_than_ncnp/other_fugitive_sources_001.json"
...
def revert_other_fugitive_sources_schema(apps, schema_monitor):
    cwd = os.getcwd()
    with open(
...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunPython(update_other_fugitive_sources_schema, revert_other_fugitive_sources_schema)]
