...
def update_storage_of_petroleum_products(apps, schema_editor):
    '''
    Add initial data to reporting.activitysourcetypejsonschema
    '''

    # Load JSON schema
    cwd = os.getcwd()
    schema_path = os.path.join(
        cwd, 'reporting/json_schemas/2024/storage_of_petroleum_products/storage_of_petroleum_products.json'
    )
    ...
    ActivitySourceTypeSchema.objects.update_or_create(
        ...
        defaults={'has_unit': False, 'has_fuel': False, 'json_schema': schema},
    )
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_storage_of_petroleum_products),
    ]
