...
def get_report_final_review_data(request: HttpRequest, version_id: int) -> Status:
...
def get_report_version_facility_report(request: HttpRequest, version_id: int, facility_id: str) -> Status:
    """
    ...
    facility_report = FacilityReport.objects.get(report_version_id=version_id, facility=facility_uuid)
