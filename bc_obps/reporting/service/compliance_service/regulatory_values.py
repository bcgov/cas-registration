...
def get_product_regulatory_values(report_version: ReportVersion, regulated_product_id: int) -> RegulatoryValues:
    """
    ...
    try:
        ...
        return get_industry_regulatory_values(report_version)
