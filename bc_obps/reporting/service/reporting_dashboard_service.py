...
class ReportingDashboardService:
    ...
    def get_operations_for_reporting_dashboard(
        ...
        if is_past_reports:
            report_subquery = report_subquery.exclude(reporting_year=reporting_year)
        else:
            report_subquery = report_subquery.filter(reporting_year=reporting_year)

        ## QUESTION: is this acceptable for past reports?
        ...
        queryset = (
            ...
            .annotate(
                ...
                reporting_year=report_subquery.values("reporting_year_id"),
    ...
    @classmethod
    def get_past_operations_for_reporting_dashboard(
        cls,
        user_guid: UUID,
        reporting_year: int,
        sort_field: Optional[str] = None,
