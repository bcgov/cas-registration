...
class ActivitySourceTypeUnitJsonSchema(BaseModel):
    ...
    reporting_activity = models.ForeignKey(
        ReportingActivity, on_delete=models.DO_NOTHING, related_name="activity_source_type_unit_json_schemas"
    )
    source_type = models.ForeignKey(
        SourceType, on_delete=models.DO_NOTHING, related_name="activity_source_type_unit_json_schemas"
    )
    json_schema = models.ForeignKey(
        JsonSchema, on_delete=models.DO_NOTHING, related_name="activity_source_type_unit_json_schemas"
    )
