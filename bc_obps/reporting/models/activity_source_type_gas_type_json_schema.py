...
from reporting.models import JsonSchema, Configuration, SourceType, GasType
import typing
...
class ActivitySourceTypeGasTypeJsonSchema(BaseModel):
    ...
    reporting_activity = models.ForeignKey(
        ReportingActivity, on_delete=models.DO_NOTHING, related_name="activity_source_type_gas_type_json_schemas"
    )
    source_type = models.ForeignKey(
        SourceType, on_delete=models.DO_NOTHING, related_name="activity_source_type_gas_type_json_schemas"
    )
    gas_type = models.ForeignKey(
        GasType, on_delete=models.DO_NOTHING, related_name="activity_source_type_gas_type_json_schemas"
    )
    json_schema = models.ForeignKey(
        JsonSchema, on_delete=models.DO_NOTHING, related_name="activity_source_type_gas_type_json_schemas"
    )
