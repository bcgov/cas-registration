...
class SourceType(BaseModel):
    ...
    json_key = models.CharField(max_length=100, db_comment="A truncated and camel cased version on the source type name that is used as a key when building the json schema dynamically")
