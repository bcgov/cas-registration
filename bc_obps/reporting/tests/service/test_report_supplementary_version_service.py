...
class ReportSupplementaryVersionServiceTests(TestCase):
    ...
    def test_is_supplementary_report_returns_false_when_no_other_submitted_version_exists(self):
        """
        Test that is_supplementary_report returns False when there is no other submitted
        ReportVersion for the same report.
        """
        result = ReportSupplementaryVersionService.is_supplementary_report(self.old_report_version.id)
        self.assertEqual(
            result,
    ...
    def test_is_supplementary_report_returns_true_when_another_submitted_version_exists(self):
        """
        Test that is_supplementary_report returns True when another submitted ReportVersion
