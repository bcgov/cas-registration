...
class ReportSupplementaryVersionServiceTests(TestCase):
    def setUp(self):
        ...
        self.old_report_version = make_recipe('reporting.tests.utils.report_version', status=ReportVersion.ReportVersionStatus.Submitted, is_latest_submitted=True)
        ...
        # Using test data imported from the ReportActivitySaveService test.
    ...
    def test_create_report_supplementary_version(self):
        ...
        self.assertEqual(new_version.report_type, self.old_report_version.report_type,
        ...
        self.assertFalse(new_version.is_latest_submitted,
