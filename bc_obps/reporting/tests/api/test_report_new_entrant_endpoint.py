    ...
    def test_saves_new_entrant_data(self, mock_save_new_entrant_data: MagicMock):
        payload = ReportNewEntrantSchemaIn(
            ...
            products=[
                ...
                {"id": 6, "name": "Gypsum wallboard", "unit": "Thousand square feet", "production_amount": 5},
                {
                    "id": 7,
                    "name": "Lime at 94.5% CaO and lime kiln dust",
                    "unit": "Tonne lime@94.5% CAO + LKD",
                    "production_amount": 5.55555,
                },
                {"id": 8, "name": "Limestone for sale", "unit": "Tonne limestone", "production_amount": 5},
            ],
            emissions=[
                {
                    "title": "Emission categories after new entrant period began",
                    "emissionData": [
                        {"id": 1, "name": "Flaring emissions", "emission": 6.1111},
                        {"id": 2, "name": "Fugitive emissions", "emission": 5.1111},
                        {"id": 3, "name": "Industrial process emissions", "emission": 9.1111},
                        {"id": 4, "name": "On-site transportation emissions", "emission": 5.1111},
                        {"id": 5, "name": "Stationary fuel combustion emissions", "emission": 7.1111},
                        {"id": 6, "name": "Venting emissions — useful", "emission": 5.1111},
                        {"id": 7, "name": "Venting emissions — non-useful", "emission": 5.1111},
                        {"id": 8, "name": "Emissions from waste", "emission": 5.1111},
                        {"id": 9, "name": "Emissions from wastewater", "emission": 7.1111},
                    ],
                },
                {
                    "title": "Emissions excluded by fuel type",
                    "emissionData": [
                        {"id": 10, "name": "CO2 emissions from excluded woody biomass", "emission": 5},
                        {"id": 11, "name": "Other emissions from excluded biomass", "emission": 5},
