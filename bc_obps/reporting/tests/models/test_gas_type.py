...
class TestInitialData(TestCase):
    def test_gas_type_initial_data(self):
        expected_gas_type_formulae = sorted([
            ...
            'HFC-23 (CHF3)', 'HFC-32 (CH2F2)', 
            'HFC-41 (CH3F)', 'HFC-43-10mee (C5H2F10)', 'HFC-125 (C2HF5)', 
            'HFC-134 (C2H2F4)', 'HFC-134a (C2H2F4)', 'HFC-143 (C2H3F3)', 
            'HFC-143a (C2H3F3)', 'HFC-152a (C2H4F2)', 'HFC-227ea (C3HF7)', 
            'HFC-236fa (C3H2F6)', 'HFC-245ca (C3H3F5)'
        ])
