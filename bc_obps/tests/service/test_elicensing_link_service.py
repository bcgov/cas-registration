...
class TestELicensingLinkService:
    ...
    def test_get_link_for_model_with_custom_elicensing_object_kind(
        ...
        # Call the method
        result = ELicensingLinkService.get_link_for_model(
            Operator, mock_operator_id, elicensing_object_kind=custom_kind
        )
        ...
        mock_get_for_model.assert_called_once_with(Operator)
        mock_get.assert_called_once_with(
            content_type=mock_content_type, object_id=mock_operator_id, elicensing_object_kind=custom_kind
        )
