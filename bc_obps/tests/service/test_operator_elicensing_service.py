...
class TestOperatorELicensingService:
    ...
    @patch('service.operator_elicensing_service.elicensing_api_client')
    @patch('service.operator_elicensing_service.OperatorELicensingService._map_operator_to_client_data')
    def test_sync_client_with_elicensing_create_client_invalid_response(
        self,
        mock_map_data,
        mock_api_client,
        mock_get,
    ...
    @patch('service.operator_elicensing_service.elicensing_api_client')
    @patch('service.operator_elicensing_service.OperatorELicensingService._map_operator_to_client_data')
    def test_sync_client_with_elicensing_request_exception(
        self,
        mock_map_data,
        mock_api_client,
        mock_get,
    ...
    @patch('service.operator_elicensing_service.elicensing_api_client')
    @patch('service.operator_elicensing_service.OperatorELicensingService._map_operator_to_client_data')
    def test_sync_client_with_elicensing_http_error(
        self,
        mock_map_data,
        mock_api_client,
        mock_get,
