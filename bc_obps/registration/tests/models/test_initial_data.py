    ...
    def test_activity_initial_data(self):
        expected_activities = sorted(
            [
                ...
                ('Coal storage at facilities that combust coal', 'all'),
                ('Copper or nickel smelting or refining', 'all'),
                ('Electricity generation', 'all'),
                ('Electronics manufacturing', 'all'),
                ('Ferroalloy production', 'all'),
                ('Glass manufacturing', 'all'),
                ('Hydrogen production', 'all'),
                ('Industrial wastewater processing', 'all'),
                ('Lead production', 'all'),
                ('Lime manufacturing', 'all'),
                ('Magnesium production', 'all'),
                ('Nitric acid manufacturing', 'all'),
                ('Petrochemical production', 'all'),
                ('Petroleum refining', 'all'),
                ('Phosphoric acid production', 'all'),
                ('Pulp and paper production', 'all'),
                ('Refinery fuel gas combustion', 'all'),
                ('Zinc production', 'all'),
                ('Open pit coal mining', 'all'),
