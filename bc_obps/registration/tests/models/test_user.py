    ...
    def setUpTestData(cls):
        ...
        cls.field_data = [
            *TIMESTAMP_COMMON_FIELDS,
            ...
            ("issuancerequest_created", "issuance request", None, None),
            ("issuancerequest_updated", "issuance request", None, None),
            ("issuancerequest_archived", "issuance request", None, None),
        ]
