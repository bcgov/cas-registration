...
class UserModelTest(BaseTestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.field_data = [
            ...
            ("reportnewentrantemissions_created", "report new entrant emissions", None, None),
            ("reportnewentrantemissions_updated", "report new entrant emissions", None, None),
            ("reportnewentrantemissions_archived", "report new entrant emissions", None, None),
