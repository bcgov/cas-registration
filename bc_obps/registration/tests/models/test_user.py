    ...
    def setUpTestData(cls):
        ...
        cls.field_data = [
            *TIMESTAMP_COMMON_FIELDS,
            ...
            ("facilitysnapshot_created", "facility snapshot", None, None),
            ("facilitysnapshot_updated", "facility snapshot", None, None),
            ("facilitysnapshot_archived", "facility snapshot", None, None),
            ...
            ("optedoutoperationdetail_created", "opted out operation detail", None, None),
            ("optedoutoperationdetail_updated", "opted out operation detail", None, None),
            ("optedoutoperationdetail_archived", "opted out operation detail", None, None),
            ...
            ('compliancereportversionmanualhandling_created', 'compliance report version manual handling', None, None),
            ('compliancereportversionmanualhandling_updated', 'compliance report version manual handling', None, None),
            ('compliancereportversionmanualhandling_archived', 'compliance report version manual handling', None, None),
            (
                'compliance_manual_handling_analyst_submitted_by',
                'compliance report version manual handling',
                None,
                None,
            ),
            (
                'compliance_manual_handling_director_decision_by',
                'compliance report version manual handling',
                None,
                None,
            ),
