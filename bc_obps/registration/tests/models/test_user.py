    ...
    def setUpTestData(cls):
        ...
        cls.field_data = [
            *TIMESTAMP_COMMON_FIELDS,
            ...
            ("user_updated", "user", None, None),
            ("user_archived", "user", None, None),
            ...
            ("reportelectricityimportdata_created", "report electricity import data", None, None),
            ("reportelectricityimportdata_updated", "report electricity import data", None, None),
            ("reportelectricityimportdata_archived", "report electricity import data", None, None),
            ...
            ("reportnewentrantemission_created", "report new entrant emission", None, None),
            ("reportnewentrantemission_updated", "report new entrant emission", None, None),
            ("reportnewentrantemission_archived", "report new entrant emission", None, None),
            ...
            ("reportemissionallocation_created", "report emission allocation", None, None),
            ("reportemissionallocation_updated", "report emission allocation", None, None),
            ("reportemissionallocation_archived", "report emission allocation", None, None),
            ...
            ("compliancechargerate_created", "compliance charge rate", None, None),
            ("compliancechargerate_updated", "compliance charge rate", None, None),
            ("compliancechargerate_archived", "compliance charge rate", None, None),
...
class TestUserRls(BaseTestCase):
    ...
    app_role=AppRole.objects.get(role_name="industry_user"),
            ...
            assert User.objects.filter(first_name=
                                       'John').exists()
...
# brianna these numbers are weird, going to have to refactor the helper I think
        ...
        test_policies_for_cas_roles(User, select_function=select_function,
            insert_function=insert_function,
            update_function=update_function)
