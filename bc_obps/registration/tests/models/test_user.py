...
class UserModelTest(BaseTestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.field_data = [
            ...
            ("reportemissionallocationnoproduct_created", "report emission allocation no product", None, None),
            ("reportemissionallocationnoproduct_updated", "report emission allocation no product", None, None),
            ("reportemissionallocationnoproduct_archived", "report emission allocation no product", None, None),
