    ...
    def setUpTestData(cls):
        ...
        cls.field_data = [
            *TIMESTAMP_COMMON_FIELDS,
            ...
            ("complianceearnedcredit_created", "compliance earned credits", None, None),
            ("complianceearnedcredit_updated", "compliance earned credits", None, None),
            ("complianceearnedcredit_archived", "compliance earned credits", None, None),
            ("compliance_earned_credit_issued_by", "compliance earned credits", None, None),
        ]
