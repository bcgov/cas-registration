...
from registration.constants import BASE_REGISTRATION_ENDPOINT, BASE_COMMON_ENDPOINT
...
class CommonTestSetup:
    ...
    base_registration_endpoint = BASE_REGISTRATION_ENDPOINT
    base_common_endpoint = BASE_COMMON_ENDPOINT
