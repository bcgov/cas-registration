...
class User(UserAndContactCommonInfo):
    ...
    documents  = models.ManyToManyField(Document,blank=True, null=True, related_name="user_documents")
    class Meta:
...
class UserOperator(models.Model):
    ...
    proof_of_authority = models.ForeignKey(Document, on_delete=models.DO_NOTHING, db_comment="", related_name='user_operators_proof_of_authority')
    signed_statuatory_declaration = models.ForeignKey(Document, on_delete=models.DO_NOTHING, db_comment="", related_name='user_operators_signed_statuatory_declaration')
    class Meta:
...
class Operation(models.Model):
    ...
    verified_at = models.DateTimeField(db_comment="",blank=True, null=True)
    verified_by = models.ForeignKey(User, on_delete=models.DO_NOTHING, db_comment="",blank=True, null=True, related_name='operations')
    estimated_emissions = models.DecimalField(decimal_places=10, max_digits=10,db_comment="")
    documents  = models.ManyToManyField(Document,blank=True, null=True, related_name='operation_documents')
