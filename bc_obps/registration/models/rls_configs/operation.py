...
class Rls:
    ...
    m2m_models_policy_mapping = {
        RegistrationTableNames.OPERATION_CONTACTS: M2MPolicyStatements(using_statement='true', delete_using_statement='true'),
        RegistrationTableNames.OPERATION_REGULATED_PRODUCTS: M2MPolicyStatements(using_statement='true', delete_using_statement='true'),
        RegistrationTableNames.OPERATION_ACTIVITIES: M2MPolicyStatements(using_statement='true', delete_using_statement='true'),
    }
