    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'duns_number',
                    models.IntegerField(blank=True, db_comment='The DUNS number of an operator', null=True),
                ),
                ...
                ('bceid', models.IntegerField(blank=True, db_comment='The BCEID identifier of an operator', null=True)),
                (
                    'compliance_entity',
                    models.ForeignKey(
                        blank=True,
                ...
                (
                    'contacts',
                    models.ManyToManyField(blank=True, related_name='operator_contacts', to='registration.contact'),
                ),
                (
                    'documents',
