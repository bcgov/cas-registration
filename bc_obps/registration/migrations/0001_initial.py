# Generated by Django 4.2.4 on 2023-09-12 21:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('npr_id', models.CharField(blank=True, db_comment='', max_length=1000)),
                ('ghfrp_id', models.CharField(blank=True, db_comment='', max_length=1000)),
                ('bcghrp_id', models.CharField(blank=True, db_comment='', max_length=1000)),
                ('petrinex_id', models.CharField(blank=True, db_comment='', max_length=1000)),
