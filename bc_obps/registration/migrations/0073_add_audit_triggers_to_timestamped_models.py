# Generated by Django 5.0.11 on 2025-02-04 21:47
    ...
    operations = [
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash='36819c75396db50e916d3a5ade7e9bca9b789510',
                    operation='INSERT',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    ...
                    hash='0d0fd041a29141ba2abe0e836232662bb63a4a80',
                    operation='UPDATE',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func="new.created_by_id = (select current_setting('my.guid')); new.created_at = now(); return new;",
                    hash='1da8280d86be6ffe85f054dcbc4e179563dd203a',
                    operation='INSERT',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func="new.updated_by_id = (select current_setting('my.guid')); new.updated_at = now(); return new;",
                    hash='ace0144a1529b691dd1bde4ffadbd906ae875756',
                    operation='UPDATE',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func="new.created_by_id = (select current_setting('my.guid')); new.created_at = now(); return new;",
                    hash='06df2286e38542bb06962b5ffbb19309a62521a5',
                    operation='INSERT',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func="new.updated_by_id = (select current_setting('my.guid')); new.updated_at = now(); return new;",
                    hash='3fb531754f45930bdbdb2cf1c5791d25d05f8532',
                    operation='UPDATE',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func="new.created_by_id = (select current_setting('my.guid')); new.created_at = now(); return new;",
                    hash='d67e9309d12270e2cec25268d6adeb91263f0e3a',
                    operation='INSERT',
        ...
        pgtrigger.migrations.AddTrigger(
            ...
            trigger=pgtrigger.compiler.Trigger(
                ...
                sql=pgtrigger.compiler.UpsertTriggerSql(
                    func="new.updated_by_id = (select current_setting('my.guid')); new.updated_at = now(); return new;",
                    hash='c993f050efd5082a3dd060a65343779280c05055',
                    operation='UPDATE',
