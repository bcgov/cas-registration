# Generated by Django 5.0.8 on 2024-08-20 23:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facilities', models.ManyToManyField(blank=True, related_name='closures', to='registration.facility')),
                (
                    'operation',
                    models.ForeignKey(
                        blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'facilities',
                    models.ManyToManyField(blank=True, related_name='temporary_shutdowns', to='registration.facility'),
                ),
                (
                    'operation',
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name='temporary_shutdowns',
                        to='registration.operation',
                    ),
                ),
                (
