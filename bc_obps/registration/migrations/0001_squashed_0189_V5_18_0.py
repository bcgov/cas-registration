# Generated by Django 5.2.16 on 2026-08-05 23:25
...
# X registration.migrations.0001_initial_squashed_0154_V5_0_0
# X registration.migrations.0156_activity_display_and_regulated_name
# X registration.migrations.0158_add_pulp_and_paper_product
# X registration.migrations.0171_add_units_to_lng_product
# X registration.migrations.0181_regulatedproduct_valid_dates
...
def update_regulated_product_units_and_is_regulated(apps, schema_editor):
    ...
    RegulatedProduct = apps.get_model('registration', 'RegulatedProduct')
    regulated_product_unit_updates = {
        'BC-specific refinery complexity throughput': 'BCRCT',
        'Cement equivalent': 'Tonne cement equivalent',
        'Chemicals: pure hydrogen peroxide': 'Tonne pure hydrogen peroxide',
        'Compression, centrifugal - consumed energy': 'MWh consumed energy',
        'Compression, positive displacement - consumed energy': 'MWh consumed energy',
        ...
        'Liquefied natural gas': None,
        'Mining: coal': 'Tonne saleable coal',
        'Mining: copper-equivalent, open pit': 'Tonne copper-equivalent',
        'Mining: copper-equivalent, underground': 'Tonne copper-equivalent',
        'Mining: gold-equivalent': 'Tonne gold-equivalent',
        'Processing sour gas - oil equivalent': 'Cubic metre oil-equivalent',
        'Processing sweet gas - oil equivalent': 'Cubic metre oil-equivalent',
        'Pulp and paper: chemical pulp': 'Tonne saleable dry chemical pulp',
        'Pulp and paper: non-chemical pulp': 'Tonne saleable dry non-chemical pulp',
        'Pulp and paper: paper (except newsprint and tissue paper)': 'Tonne saleable paper',
        'Pulp and paper: tissue Paper': 'Tonne saleable tissue paper',
        'Rendering and meat processing: protein and fat': 'Tonne protein and fat',
        'Renewable diesel': None,
        'Smelting: aluminum': 'Tonne saleable aluminum',
        'Smelting: lead-zinc': 'Tonne lead-zinc',
        'Sold electricity': 'GWh',
        'Sold Heat': 'GJ',
        'Steel wire: HDG-process (hot dip galvanization)': 'Tonne hot dip galvanization wire',
        'Steel wire: Non-HDG': 'Tonne non-HDG wire',
        'Sugar: liquid': 'Tonne solid sugar content',
        'Sugar: solid': 'Tonne solid sugar',
        'Wood products: lumber': 'Cubic metre saleable lumber',
        'Wood products: medium density fibreboard (MDF)': 'Cubic metre saleable MDF',
        'Wood products: plywood': 'Cubic metre saleable plywood',
        'Wood products: veneer': 'Cubic metre saleable veneer',
        'Wood products: wood chips (including hog fuel)': 'Cubic metre saleable wood chips',
        'Wood products: wood pellets': 'Tonne saleable wood pellets',
        'Forged steel balls: less than 3.5 inches diameter': 'Tonne forged steel balls',
        'Forged steel balls: greater than 4 inches diameter': 'Tonne forged steel balls',
    }

    for product_name, unit in regulated_product_unit_updates.items():
        RegulatedProduct.objects.filter(name=product_name).update(unit=unit)
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(related_name='facilities', to='registration.wellauthorizationnumber'),
                ),
            ],
            options={
