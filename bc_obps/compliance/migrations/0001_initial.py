# Generated by Django 5.0.11 on 2025-02-19 05:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'amount',
                    models.DecimalField(db_comment='The amount of the obligation', decimal_places=4, max_digits=20),
                ),
                (
                    'status',
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'historical compliance summary',
                'verbose_name_plural': 'historical compliance summarys',
                'db_table': 'erc_history"."compliance_summary_history',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
