# Generated by Django 5.1.14 on 2025-11-18 20:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('context', models.TextField(db_comment='Reason for requiring manual handling.')),
                (
                    'status',
                    models.CharField(
                        choices=[
                            ('action_required', 'Supplementary report- action required'),
                            ('issue_resolved', 'Supplementary report - resolved'),
                        ],
