...
class TestElicensingInvoicesEndpoint(CommonTestSetup):
    ...
    def test_get_compliance_report_versions_list_success_for_irc_user(self, mock_get_invoices):
        ...
        report_version_1=make_recipe(
            "reporting.tests.utils.report_version", report=report_1)
        
        report_operation_1 = make_recipe(
            "reporting.tests.utils.report_operation",report_version=report_version_1
        )
        ...
        compliance_report_version_1 = make_recipe(
           ...
           compliance_report=compliance_report_1, report_compliance_summary=report_compliance_summary_1
        )
