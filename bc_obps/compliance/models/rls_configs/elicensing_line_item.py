...
class Rls:
    """
    RLS configuration for the ElicensingLineItem model
    """

    enable_rls = True
    schema = "erc"
    table = ComplianceTableNames.ELICENSING_LINE_ITEM
    using_statement = """
    ...
    grants = generate_rls_grants(role_grants_mapping, ComplianceTableNames.ELICENSING_LINE_ITEM)
