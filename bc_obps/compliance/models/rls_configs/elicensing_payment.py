...
class Rls:
    """
    RLS configuration for the ElicensingPayment model
    """

    enable_rls = True
    schema = "erc"
    table = ComplianceTableNames.ELICENSING_PAYMENT
    using_statement = """
    ...
    grants = generate_rls_grants(role_grants_mapping, ComplianceTableNames.ELICENSING_PAYMENT)
