...
> [!WARNING]
> There are [a few steps](migration-test-charts.md#prerequisites-to-use-an-empty-namespace-destination-ns-to-test-the-migrations-from-source-devtestprod) to go through before a namespace can be used to test migrations
