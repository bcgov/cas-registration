...
- During our overnight processes, each obligation invoice is inspected by the system to see if it has recently been paid (elicensinginvoice.fee_amount_balance == $0.00) and if a penalty or penalties should be applied.
